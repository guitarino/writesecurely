            ...
            <article class="WelcomePage__WelcomeCard">
                ...
                <section class="WelcomePage__HowSection">
                    ...
                    <ol class="WelcomePage__HowList">
                        ...
                        <li class="WelcomePage__HowListItem">Choose a password used to encrypt diaries and notes with AES-256 encryption.</li>
                        <li class="WelcomePage__HowListItem">Create, edit and delete private notes, create and customize multiple diaries. Nobody will be able to read your diary without knowing the chosen password.</li>
                    </ol>
                </section>
                {
                    credentials.error ?
